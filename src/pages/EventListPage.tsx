...
const EventListPage: React.FC = () => {
    ...
    async function handleDelete(eventId: number) {
        try {
            ...
            console.log("Message défini :", "🎉 Événement supprimé avec succès !");
            ...
            setTimeout(() => {
                ...
                console.log("Message réinitialisé :", successMessage); 
            }, 3000);
        } catch (error: unknown) {
    ...
    return (
        ...
        {/* Message de succès lors de la suppresion d'event*/}
        {successMessage && (
